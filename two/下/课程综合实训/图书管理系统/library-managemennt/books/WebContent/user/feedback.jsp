...
<head>
	...
	<style>
		body {
			background-image: url("${pageContext.request.contextPath}/static/images/04.jpg");
		}
	</style>
</head>
					...
					<div class="col-lg-12">
						<div class="panel panel-default bootstrap-admin-no-table-panel">
							...
							<div
								...
								<form class="form-horizontal" action="/books/problem?method=addProblem"
									method="post">
									<div class="col-lg-8 form-group">
										<label class="col-lg-4" for="query_bname">标题</label>
										<div class="col-lg-12">
											<input class="form-control" id="bookName" name="title"
									...
									<div class="col-lg-8 form-group">
										...
										<div class="col-lg-12">
											<input class="form-control" id="bookName" name="link"
									...
									<div class="col-lg-8 form-group">
										...
										<label for="query_bname" style="display: none;"></label>&nbsp;
										<a href="/books/problem?method=listByPage"><i

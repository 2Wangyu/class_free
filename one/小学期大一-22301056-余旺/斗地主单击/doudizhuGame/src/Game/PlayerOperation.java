...
import java.util.List;
    ...
    public class PlayerOperation extends Thread {
        ...
        public void ShowCard(int role) {
            ...
            if (gameJFrame.time[(role + 1) % 3].getText().equals("不要") && gameJFrame.time[(role + 2) % 3].getText().equals("不要")) {
                ...
                if (role != gameJFrame.dizhuFlag) {
                    ...
                    if ((role + 1) % 3 == gameJFrame.dizhuFlag) {
                        if ((Common.jugdeType(gameJFrame.allLists.get((role + 2) % 3)) != PokerType.c1
                                || Common.jugdeType(gameJFrame.allLists.get((role + 2) % 3)) != PokerType.c2)
                                && gameJFrame.allLists.get(gameJFrame.dizhuFlag).size() < 1)
                            f = 1;
                        if (gameJFrame.allLists.get((role + 2) % 3).size() > 0
                                && Common.getValue(gameJFrame.allLists.get((role + 2) % 3).get(0)) > 13)
                            f = 1;
                    }
                    if (f == 1) {
                ...
                if (gameJFrame.time[(role + 2) % 3].getText().equals("不要"))
                    player = gameJFrame.allLists.get((role + 1) % 3);
                else
                    player = gameJFrame.allLists.get((role + 2) % 3);
            ...
            gameJFrame.allLists.get(role).clear();
            if (list.size() > 0) {
                Point point = new Point();
                if (role == 0)
                    point.x = 200;
                if (role == 2)
                    point.x = 550;
                if (role == 1) {
                    point.x = (770 / 2) - (gameJFrame.allLists.get(1).size() + 1) * 15 / 2;
                    point.y = 300;
                }
                point.y = (400 / 2) - (list.size() + 1) * 15 / 2;
                ArrayList<Poker> temp = new ArrayList<>();
                for (int i = 0, len = list.size(); i < len; i++) {
                    java.util.List<Poker> pokers = getCardByName(gameJFrame.playerList.get(role), list.get(i));
                ...
                for (Poker poker : temp) {
                    ...
                    gameJFrame.allLists.get(role).add(poker);
            ...
            for (Poker poker : gameJFrame.allLists.get(role))
                poker.turnFront();
        }

        public java.util.List getCardByName(java.util.List<Poker> list, String n) {
            String[] name = n.split(",");
        ...
        public void AI_3(java.util.List<String> model, java.util.List<Poker> player, java.util.List<String> list, int role) {
        ...
        public void AI_4(java.util.List<String> model1, java.util.List<String> model2, java.util.List<Poker> player, java.util.List<String> list, int role) {
        ...
        public void AI_5(java.util.List<String> model1, java.util.List<String> model2, java.util.List<Poker> player, java.util.List<String> list, int role) {
            player = Common.getOrder2(player);
            int len1 = model1.size();
            int len2 = model2.size();
        ...
        public void AI_1(java.util.List<String> model, java.util.List<Poker> player, java.util.List<String> list, int role) {
        ...
        public void AI_2(java.util.List<String> model1, java.util.List<String> model2, java.util.List<Poker> player, List<String> list, int role) {
            player = Common.getOrder2(player);
            int len1 = model1.size();
            int len2 = model2.size();
        ...
        public void timeWait(int n, int player) {
            ...
            if (gameJFrame.allLists.get(player).size() > 0)
                Common.hideCards(gameJFrame.allLists.get(player));
            if (player == 1) {
                int i = n;
